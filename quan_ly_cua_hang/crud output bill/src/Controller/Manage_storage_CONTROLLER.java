...
//Input_bill
    ...
    public boolean insert_input(Item item, Product prod) {

        return prod.update() && item.insert();
    }

    public boolean insert_input(Product prod, Item item) {

        return prod.insert() && item.insert();
    }

    public boolean insert_output(Item item, Product prod) {
    ...
    public ArrayList<Item> getListItems(String id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Item item = new Item(code_bill, code_product, code_sup, code_type, quantity);
                list.add(item);
            }
            con.close();
            s.close();
