...
public class Product implements CRUD {
    ...
    //lấy ra từ database
    public Product(String Ma_Thiet_Bi, String Ten_Thiet_Bi, String Ma_NSX, String Ma_Loai, int So_Luong, int Gia_Thanh, int Profit, String Anh_SP) {
    ...
    public int Amount_sale() {
        return (this.getPrice() / (100 - this.getProfit())) * 100;
    }

    public int Amount_input() {
        return this.Price * this.Quantity;
    }

    @Override
    public String toString() {
        return "Product{" + "Code_product=" + Code_product + ", Name=" + Name + ", Code_supplier=" + Code_supplier + ", Code_type=" + Code_type + ", Quantity=" + Quantity + ", Price=" + Price + ", Profit=" + Profit + ", Image=" + Image + '}';
    }
    ...
    public boolean update() {
        ...
        String sql_ = "UPDATE status\n"
                + "SET QUANTITY = '" + this.getQuantity() + "' , PRICE = '" + this.getPrice() + "' , PROFIT = '" + this.getProfit() + "'\n"
                + "WHERE\n"
                + "	CODE_PRODUCT = '" + this.getCode_product() + "'";
        try {
            con = db.connect();
